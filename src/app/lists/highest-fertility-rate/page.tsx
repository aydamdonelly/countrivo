...
export default function HighestFertilityRatePage() {
  ...
  return (
    <>
      ...
      />
      <ListItemJsonLd
        name="Countries with Highest Fertility Rate"
        description="The 50 countries with the highest total fertility rate, measured in births per woman."
        url="/lists/highest-fertility-rate"
        items={rows
          .filter((r) => r.country)
