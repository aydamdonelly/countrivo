...
export default function RichestCountriesPage() {
  ...
  return (
    <>
      ...
      />
      <ListItemJsonLd
        name="Richest Countries in the World by GDP per Capita"
        description="The 50 richest countries ranked by GDP per capita in current US dollars."
        url="/lists/richest-countries"
        items={rows
          .filter((r) => r.country)
