...
export default function CountriesInAmericasPage() {
  ...
  return (
    <>
      ...
      />
      <ListItemJsonLd
        name="All Countries in the Americas"
        description="Every country in North, Central, and South America, listed by population, with capital and area."
        url="/lists/countries-in-americas"
