...
export default function MostConnectedCountriesPage() {
  ...
  return (
    <>
      ...
      />
      <ListItemJsonLd
        name="Most Connected Countries by Internet Usage"
        description="The 50 most connected countries ranked by percentage of population using the internet."
        url="/lists/most-connected-countries"
        items={rows
          .filter((r) => r.country)
