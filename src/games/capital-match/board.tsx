...
export function Board({ state, dispatch, busy }: BoardProps<CapitalState, CapitalAction>) {
  ...
  return (
    <div className="play-stack">
      <CountryBlock key={state.g.currentQuestion} country={q.country} meta="What is the capital?" animate={state.g.currentQuestion !== first.current} alt={q.country.displayName} />
