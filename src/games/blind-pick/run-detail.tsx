...
import type { BlindPickResult } from "@/lib/game-logic/blind-pick/types";
...
function gradeWord(value: unknown): string | null {
  return typeof value === "string" && value in GRADE_WORD ? GRADE_WORD[value as BlindPickResult["grade"]] : null;
}

/**
 * The rows behind a shared Blind Pick run (blueprint 7.7): the grade and the three numbers, then
