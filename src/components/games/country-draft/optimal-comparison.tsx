...
export function OptimalComparison({
  ...
  return (
    <div className="border border-border rounded-2xl overflow-hidden">
      {/* Header */}
      <div className="grid grid-cols-[1fr_auto_auto] gap-3 px-5 sm:px-6 py-3 bg-surface-muted text-sm font-bold text-text-muted border-b border-border">
        <span>Country</span>
        ...
        return (
          <div
            ...
            className={cn(
              ...
              isClose && !isMatch && "bg-brand-subtle"
            )}
          >
            ...
            <div className="flex items-center justify-center gap-1.5 w-28 sm:w-32">
              ...
              <span
                className={cn(
                  ...
                  pa.rank > 5 && pa.rank <= 20 && "text-brand-dark",
      ...
      {/* Totals */}
      <div className="grid grid-cols-[1fr_auto_auto] gap-3 px-5 sm:px-6 py-4 bg-surface-muted text-base font-extrabold border-t border-border">
        <span>Total</span>
        <span className="text-center w-28 sm:w-32 font-mono">
          {playerAssignments.reduce((s, a) => s + a.rank, 0)}
        </span>
        <span className="text-center w-28 sm:w-32 font-mono text-text-muted">
